...
ActiveRecord::Schema.define(version: 20140616064407) do
  ...
  create_table "categories_intervention_types", id: false, force: true do |t|
  ...
  create_table "intervention_types_service_providers", force: true do |t|
